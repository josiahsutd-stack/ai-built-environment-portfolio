# AI Skills Coverage Matrix

Legend: **strong** = primary project signal, **medium** = meaningful implementation, **light** = supporting exposure.

| Skill | Strong Coverage | Medium Coverage | Light Coverage |
| --- | --- | --- | --- |
| Python | All projects |  |  |
